...
public class ClassChooserAdapter extends BaseAdapter {
    private List<String> classes;
    private Context mContext;

    public ClassChooserAdapter(List<String> dtos, Context mContext) {
        this.classes = dtos;
    ...
    public long getItemId(int position) {
        return classes.indexOf(classes.get(position));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final String dto = classes.get(position);
